...
अपने लिए उपयुक्त स्थापना पथ चुनें:

### विकल्प 1: अंतिम उपयोगकर्ताओं के लिए (अनुशंसित)

VS Code Marketplace से चामेलियन एक्सटेंशन स्थापित करने और उपयोग करने के लिए इन चरणों का पालन करें।

**चरण 1: निर्भरताएं स्थापित करें**

चामेलियन को काम करने के लिए `Claude Code` और `Claude Code Router` की आवश्यकता है। हमने इसे आसान बनाया है:
1. पहले, VS Code में इस एक्सटेंशन को स्थापित करें (चरण 2 देखें)।
2. कमांड पैलेट खोलें (`Ctrl+Shift+P` या `Cmd+Shift+P`)।
3. `Chameleon: स्थापना गाइड खोलें` कमांड चलाएं।
4. Node.js, Git और अन्य पूर्वापेक्षाओं की स्थापना पूरी करने के लिए गाइड में विस्तृत चरणों का पालन करें।

**चरण 2: एक्सटेंशन स्थापित करें**

1. Visual Studio Code खोलें।
2. एक्सटेंशन व्यू पर जाएं (`Ctrl+Shift+X`)।
3. **"Chameleon - 智能文档助手"** खोजें।
4. "स्थापित करें" पर क्लिक करें।

**चरण 3: AI प्रदाताओं को कॉन्फ़िगर करें**
