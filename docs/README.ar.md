...
اختر مسار التثبيت المناسب لك:

### الخيار 1: للمستخدمين النهائيين (موصى به)

اتبع هذه الخطوات لتثبيت واستخدام امتداد الحرباء من VS Code Marketplace.

**الخطوة 1: تثبيت التبعيات**

يتطلب الحرباء `Claude Code` و `Claude Code Router` للعمل. لقد جعلنا هذا سهلاً:
1. أولاً، قم بتثبيت هذا الامتداد في VS Code (انظر الخطوة 2).
2. افتح لوحة الأوامر (`Ctrl+Shift+P` أو `Cmd+Shift+P`).
3. نفذ الأمر `Chameleon: فتح دليل التثبيت`.
4. اتبع الخطوات التفصيلية في الدليل لإكمال تثبيت Node.js، Git، والمتطلبات الأساسية الأخرى.

**الخطوة 2: تثبيت الامتداد**

1. افتح Visual Studio Code.
2. انتقل إلى عرض الامتدادات (`Ctrl+Shift+X`).
3. ابحث عن **"Chameleon - 智能文档助手"**.
4. انقر على "تثبيت".

**الخطوة 3: تكوين مزودي الذكاء الاصطناعي**
